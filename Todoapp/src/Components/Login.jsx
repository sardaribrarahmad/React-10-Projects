        ...
        <div className="flex items-center h-[50%] mt-10 justify-center">
          ...
          <h1 className="text-3xl font-bold mb-4 w-full flex justify-center">
            -or-
              ...
              <form className=" w-[100%] md:w-[60%] flex flex-col  justify-items-center mx-auto" onSubmit={handleSubmit}>
                <div className="mb-2">
                  <label className="block text-gray-800 text-xl  font-bold" htmlFor="">
                    Email
                  </label>
                  <input
              ...
              <div className="text-center space-x-2 space-y-2">
                <span className="text-gray-700 text-xl">D'not have an account?</span>
                <button
